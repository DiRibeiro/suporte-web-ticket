    ...
    <div class="field">
      <label for="nome" class="label-with-help">
        ...
        <span
          class="help-icon"
          tabindex="0"
          aria-label="Ajuda sobre o campo Nome"
        >
          ❓
          <span class="tooltip">
            Nome completo do usuário, usado para identificação nos tickets.
          </span>
        </span>
      </label>
      <input
    ...
    <div class="field">
      <label for="email" class="label-with-help">
        ...
        <span
          class="help-icon"
          tabindex="0"
          aria-label="Ajuda sobre o campo E-mail"
        >
          ❓
          <span class="tooltip">
            Endereço de e-mail do usuário, usado para contato e notificações.
          </span>
        </span>
      </label>
      <input
